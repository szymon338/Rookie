...
$sql = "INSERT INTO signup (company, datework, tasks, institution, dateedu, studies, qual) VALUES ('$company', '$datework', '$tasks', '$institution', '$dateedu', '$studies', '$qual')";
if(mysqli_query($link, $sql)){
    header('Location: 6-bio.html');
     exit();
} else{
